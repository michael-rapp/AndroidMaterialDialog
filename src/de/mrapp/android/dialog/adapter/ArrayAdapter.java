...
/**
 * An adapter, which is extended from the class
 * {@link android.widget.ArrayAdapter} in order to be able to customize the text
 * and control color of the adapter's items.
 * 
 * @param <Type>
...
public class ArrayAdapter<Type> extends android.widget.ArrayAdapter<Type> {
	...
	/**
	 * The id of the text view within the adapter's layout resource to be
	 * populated.
	 */
	 ...
	 *            null
	 * @param resourceId
	 *            The resource id of the layout, which should be used by the
	 *            adapter, as an {@link Integer} value. The resource id must
	 *            correspond to a valid layout resource
	 */
	 ...
	 *            The id of the text view within the layout resource to be
	 *            populated, as an {@link Integer} value
	 */
	 ...
	 *            The items of the adapter as an array of the generic type Type
	 */
	public ArrayAdapter(final Context context, final int resourceId, final int textViewResourceId, final Type[] items) {
	 ...
	 *            correspond to a valid layout resource
	 * @param items
	 *            A list, which contains the items of the adapter, as an
	 *            instance of the type {@link List}
	 */
	 ...
	 * 
	 * @return The text color of the adapter's items as an {@link Integer} value
	 *         or -1, if no custom color has been set
	 */
	 ...
	 * 
	 * @param color
	 *            The text color, which should be set, as an {@link Integer}
	 *            value or -1, if no custom color should be set
	 */
	 ...
	 * 
	 * @return The control color of the adapter's items as an {@link Integer}
	 *         value or -1, if no custom color has been set
	 */
	 ...
	 * 
	 * @param color
	 *            The control color, which should be set, as an {@link Integer}
	 *            value or -1, if no custom color should be set
	 */
	...
	public final View getView(final int position, final View convertView, final ViewGroup parent) {
		...
		if (getItemColor() != -1) {
			...
			if (textView != null) {
				...
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN && getItemControlColor() != -1
						&& textView instanceof CheckedTextView) {
					CheckedTextView checkedTextView = (CheckedTextView) textView;
					ColorFilter colorFilter = new PorterDuffColorFilter(getItemControlColor(), Mode.SRC_IN);

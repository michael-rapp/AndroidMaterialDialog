 ...
 * @since 3.7.0
 */
public class ScaleAnimation extends DrawableAnimation {
    ...
    protected static class Builder
            extends AbstractDrawableAnimationBuilder<ScaleAnimation, Builder> {
        ...
        @NonNull
        @Override
        protected final ScaleAnimation onCreateProduct() {
            return new ScaleAnimation(getContext());
        }
     ...
     *         {@link Context}. The context may not be null
     */
    protected ScaleAnimation(@NonNull final Context context) {
        super(context);
    }
